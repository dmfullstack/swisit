...
public class CrawlerRestController {
	...
	public ResponseEntity<Map<String,String>> receiveMessage() throws JsonParseException, JsonMappingException, IOException{
		...
		List<SearcherResult> c=subscriber.receivingMessage("testcontrol");
		SearcherResult searcherResult[]= new SearcherResult[c.size()];
		c.toArray(searcherResult);
		
		for(SearcherResult sb:c){
